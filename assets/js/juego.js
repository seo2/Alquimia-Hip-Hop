				    ...
				    drop: function( event, ui ) {
						...
						if(!$( this ).hasClass('temp')){ 
					        ...
					        if($(ui.draggable).hasClass('bboy')){
						        ...
						        $( this ).removeClass('bboy');
						        $( this ).addClass('batalla');
						        $( this ).html('<img src="assets/img/elementos/batalla.png">');
						        if( $( '#elementos ul li .batalla' ).hasClass('hide')){
						        	$( '#elementos ul li .batalla' ).removeClass('hide');
						        	puntaje++;
						        	
						        	$('#puntaje span').html(puntaje);
						        	localStorage.setItem('batalla',1);
						        	localStorage.setItem('puntaje',puntaje);
			 	...
			 	$( ".mc" ).droppable({
				    drop: function( event, ui ) {
						...
						if(!$( this ).hasClass('temp')){ 
					        ...
					        if($(ui.draggable).hasClass('pacos')){
						        
						        $( this ).removeClass('mc');
						        $( this ).addClass('fuckthepolice');
						        $( this ).html('<img src="assets/img/elementos/fuckthepolice.png">');
						        if( $( '#elementos ul li .fuckthepolice' ).hasClass('hide')){
						        	$( '#elementos ul li .fuckthepolice' ).removeClass('hide');
						        	puntaje++;
					        ...
					        if($(ui.draggable).hasClass('cadena')){
						        
						        $( this ).removeClass('mc');
						        $( this ).addClass('kangol');
						        $( this ).html('<img src="assets/img/elementos/kangol.png">');
						        if( $( '#elementos ul li .kangol' ).hasClass('hide')){
						        	$( '#elementos ul li .kangol' ).removeClass('hide');
						        	puntaje++;
						        	
						        	$('#puntaje span').html(puntaje);
						        	localStorage.setItem('kangol',1);
						        	localStorage.setItem('puntaje',puntaje);
