...
-->
	   		...
	   		<ul id="lista">
		   		...
		   		<li id="drum" >			<div id="dragtren" class="drag-me temp hide drum"><img src="assets/img/elementos/drum.png"></div></li>
	   		</ul>
...
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <script src="assets/js/juego.js?v=1"></script>
